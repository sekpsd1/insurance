...
- Results plan detail expansion now places own-damage coverage before lost/fire coverage, labels own damage as `3.1`, labels lost/fire as `3.2`, and type 3 uses the shorter `3.1 ความคุ้มครองความเสียหายต่อรถยนต์` label without the land-vehicle collision wording.
